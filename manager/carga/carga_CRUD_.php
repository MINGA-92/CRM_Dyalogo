                                    ...
                                    if($res->num_rows > 0){
                                        ...
                                        if($datoLsql['PREGUN_IndiUnic__b'] == 1){
                                            ...
                                            if($res->num_rows > 0){
                                                $fallaValidacion++;
                                                $InsertarRegistro = 0;
                                                $LsqlInsertLog = "INSERT INTO ".$BaseDatos_systema.".LOG_CARGUE (LOG_CARGUE_Fila_b, LOG_CARGUE_Mensaje_b, LOG_CARGUE_Token_b) VALUES (".$index.", 'Registro duplicado en ".$datoLsql['PREGUN_Texto_____b']." con valor ".$variable."', '".$_SESSION['TOKEN']."')";
                                                //echo $LsqlInsertLog;
                                ...
                                if($ColumnaAgente != 'NONE'){
                                    ...
                                    if($res->num_rows > 0 && $value[$datosArray[$ColumnaAgente]] != '' && !is_null($value[$datosArray[$ColumnaAgente]])){
                                        ...
                                        if($res->num_rows == 0){
                                            ...
                                            if($mysqli->query($Lsql) === false){
                                                // no se pudo agregar a asitar el usuario
                                                $falla++;
                                        ...
                                        if($mysqli->query($Lsql) === false){
                                            //no se pudo asignar el registro al usuario
                                            $falla++;
                                            $LsqlInsertLog = "INSERT INTO ".$BaseDatos_systema.".LOG_CARGUE (LOG_CARGUE_Fila_b, LOG_CARGUE_Mensaje_b, LOG_CARGUE_Token_b) VALUES (".$index.", '".str_replace("'", "", $mysqli->error)."', '".$_SESSION['TOKEN']."')";
                                            //echo $LsqlInsertLog;
                                            $mysqli->query($LsqlInsertLog);
                                        ...
                                        //el usuarios no existe
                                        $falla++;
                                        $LsqlInsertLog = "INSERT INTO ".$BaseDatos_systema.".LOG_CARGUE (LOG_CARGUE_Fila_b, LOG_CARGUE_Mensaje_b, LOG_CARGUE_Token_b) VALUES (".$index.", 'El usuario ".$value[$datosArray[$ColumnaAgente]]." no existe', '".$_SESSION['TOKEN']."')";
                                        //echo $LsqlInsertLog;
                                        $mysqli->query($LsqlInsertLog);  
                                    }
                                }
                                                ...
                                                if(isset($ColumnaAgente)){
                                                    if($ColumnaAgente != 'NONE'){
                                                        ...
                                                        if($res->num_rows > 0 && $value[$datosArray[$ColumnaAgente]] != '' && !is_null($value[$datosArray[$ColumnaAgente]])){
                                                            ...
                                                            $insertarMuestraLsql = "INSERT INTO  ".$BaseDatos.".".$muestraCompleta." (".$muestraCompleta."_CoInMiPo__b ,  ".$muestraCompleta."_NumeInte__b, ".$muestraCompleta."_Estado____b , ".$muestraCompleta."_ConIntUsu_b) VALUES (".$ultimoResgistroInsertado.", 0 , 0, ".$datoLsql['USUARI_ConsInte__b'].");";
                                                            if($mysqli->query($insertarMuestraLsql)){
                                                                //no se pudo asignar el registro al usuario
                                                                $falla++;
                                                                $LsqlInsertLog = "INSERT INTO ".$BaseDatos_systema.".LOG_CARGUE (LOG_CARGUE_Fila_b, LOG_CARGUE_Mensaje_b, LOG_CARGUE_Token_b) VALUES (".$index.", '".str_replace("'", "", $mysqli->error)."', '".$_SESSION['TOKEN']."')";
                                                                //echo $LsqlInsertLog;
