<?php
    ...
    function insertarLogconsulta($boo_p,$intInsertId_p=null,$intIdBase_p=null,$intIdMuestra_p=null,$intIdPaso_p=null,$strConsulta_p=null,$strAccion_p=null,$strErrores_p=null,$strUnionCampo_p=null){
        ...
        if ($boo_p) {
            ...
            if ($strErrores_p != "" && !is_null($strErrores_p)) {
                ...
                echo "strErrores_t => $strErrores_t <br><br>" ;
            }
    ...
    function validarLongitudCampo($strNombreTablaTemporal, $strNombreCampo, $intLongitudCampo)
    {
        ...
        $consulta = "SELECT {$strNombreCampo} AS valor FROM dy_cargue_datos.{$strNombreTablaTemporal}";
        ...
        if (mysqli_num_rows($sql) > 0) {
            ...
            characterCut($result, $intLongitudCampo);
        }
    }
    
    function characterCut($arrayCadena, $intLongitudCampo)
	{
		# se parsea el valor a int
		# se cuenta la Longitud de la variable[arrayCadena] 
        foreach ($arrayCadena as $key => $value) {
            # code...
            echo "value =>", json_encode($value), "<br><br>";
            echo "key =>", json_encode($key), "<br><br>";
            $intLongitudCampo = intval($intLongitudCampo);
            $intCadenaLength = mb_strlen($value) - $intLongitudCampo;
    
            if (!$intCadenaLength == 0 && mb_strlen($value) > $intLongitudCampo) {
                # Solo se corta la cade que llega del guion, cuando sea mayor a la longitud, configurada en pregun
                $value = substr($value, -0, -$intCadenaLength);
            ...
            case 1: 
                ...
                if($intValidador_p==2){
                    ...
                    while ($row = $resSQLPatrones_t->fetch_object()) {
                        ...
                        $strFalseRegexp_t .= " AND ".$strNombreCampo_p." NOT REGEXP ".$row->patron;
...
<?php
    ...
    */
    ...
    if(isset($_GET['validaCampos'])) {
        ...
        echo "intLongitudCampo => $intLongitudCampo <br><br>";
    ...
    if (isset($_GET["transaccionesBd"])) {
        ...
        //JDBD - Armamos los valores para los campos a tramitar.
            ...
            foreach ($arrInfoCampos_t as $objeto) {
                if (is_numeric($objeto["intIdCampo_t"])) {
                    ...
                    // echo "strCamposInsert_t => $strCamposInsert_t";
            ...
            if ($intIdOrigen_DY_t != 0) {
                $strCamposUpdate_t .=",A.G".$intIdBase_t."_C".$intIdOrigen_DY_t." = '".$strNombreExcell_t."'";
            }
            ...
            if ($intIdMuestra_t != -1) {
                if ($intReLlamar_t==1) {
                    ...
                    if($strTipificacionNoUpdate_t !='' && $strTipificacionNoUpdate_t != null){
                        ...
                        JOIN ".$BaseDatos.".G".$intIdBase_t." B ON A.G".$intIdBase_t."_M".$intIdMuestra_t."_CoInMiPo__b = B.G".$intIdBase_t."_ConsInte__b JOIN dy_cargue_datos.".$strTablaTemp_t." C ON B.".$strCampoUnion_t." = C.".$strCampoUnion_t." SET A.G".$intIdBase_t."_M".$intIdMuestra_t."_Activo____b = -1, G".$intIdBase_t."_M".$intIdMuestra_t."_Estado____b = 0, G".$intIdBase_t."_M".$intIdMuestra_t."_NumeInte__b = 0,G".$intIdBase_t."_M".$intIdMuestra_t."_FecHorAge_b = NULL,G".$intIdBase_t."_M".$intIdMuestra_t."_UltiGest__b = NULL,G".$intIdBase_t."_M".$intIdMuestra_t."_FecHorMinProGes__b = NULL WHERE C.TRAMITADO = 1 AND G".$intIdBase_t."_M".$intIdMuestra_t."_UltiGest__b NOT IN ({$strTipificacionNoUpdate_t})";
                    }else{
                        //JDBD - Se reinician los registros en el Excell existentes en Dyalogo.
                        $strSQLUpdateReinicio_t = "UPDATE ".$BaseDatos.".G".$intIdBase_t."_M".$intIdMuestra_t." A
                                                   JOIN ".$BaseDatos.".G".$intIdBase_t." B ON A.G".$intIdBase_t."_M".$intIdMuestra_t."_CoInMiPo__b = B.G".$intIdBase_t."_ConsInte__b JOIN dy_cargue_datos.".$strTablaTemp_t." C ON B.".$strCampoUnion_t." = C.".$strCampoUnion_t." SET A.G".$intIdBase_t."_M".$intIdMuestra_t."_Activo____b = -1, G".$intIdBase_t."_M".$intIdMuestra_t."_Estado____b = 0, G".$intIdBase_t."_M".$intIdMuestra_t."_NumeInte__b = 0,G".$intIdBase_t."_M".$intIdMuestra_t."_FecHorAge_b = NULL,G".$intIdBase_t."_M".$intIdMuestra_t."_UltiGest__b = NULL,G".$intIdBase_t."_M".$intIdMuestra_t."_FecHorMinProGes__b = NULL WHERE C.TRAMITADO = 1";
                    }
        ...
        //JDBD - Insertamos lo nuevo en la base
            ...
            // echo "strSQLInsertBase_t->1 => $strSQLInsertBase_t <br><br>";
            // echo "intErrorId_t->1 => $intErrorId_t <br><br>";
        ...
        //JDBD - Insertamos lo nuevo telefonos errados en la base
            ...
            // echo "strSQLInsertBase_t->2 => $strSQLInsertBase_t <br><br>";
            // echo "intErrorId_t->2 => $strSQLInsertBase_t <br><br>";
