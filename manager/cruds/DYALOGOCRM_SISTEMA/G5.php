    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <div class="modal-footer">
                ...
                <input type="" name="IdseccionCrear" id="IdseccionCrear" value="0">
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form id="editarseccionesModalForm">
                    ...
                    <input type="" name="IdseccionEdicion" id="IdseccionEdicion" value="0">
                    <input type="" name="contadorEditablesPreguntas" id="contadorEditablesPreguntas" value="0">
            ...
            <div class="modal-body">
                <form id="loqueVengaGenerad0" style="padding: 0px 20px;">
                    ...
                    <div class='row' id="NumericoDiv">
                        <div class='col-md-8 formato' style="display: none;">
                            <div class="form-group">
...
<input type="" id="cuantoscampos" value="0">
<input type="hidden" id="guionWS" value="">
<input type="" id="llave" value="">
...
<script type="text/javascript">
    ...
    function getSeccionesGuion(byModulo=0) {
        $.ajax({
            ...
            dataType: 'html',
            success: function(data) {
                console.log('se carga la seccion[data] :>> ', data);
                    ...
                    alertify.confirm("<?php echo $str_message_genericoDel; ?>", function(e) {
                        if (e) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    console.log('data seccion_ :>> ', data );
                                    if (data == '0') {
                                        alertify.success('<?php echo $str_Exito;?>');
                ...
                $(".btnEditarSeccion").click(function() {
                    addOptSec();
                    console.log('$(this)valorseccion :>> ', $(this).attr('valorseccion'));
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#btnAddMoreSeccion").click(function() {
            console.log('se oprime el botton "Agregar Sección":>> ');
            ...
            $("#cuantoscampos").val(0);
            $("#G7_C38").val('1').change();
            // $('#crearSeccionesModalButton').click()
        });
        ...
        $("#newFieldSeccion").click(function() {
            ...
            console.log('se oprime el botton "Agregar Campo" se abre config :>> ', editaCampos);
            alert(editaCampos)
            ...
            cuerpoTablaQuesedebeGuardar = '<div class="row" id="campos_' + editaCampos + '" numero="' + editaCampos + '">' +
                ...
                '<div class="col-md-1"  style="text-align:center;"><label><input type="checkbox" value="-1" name="G6_C41_' + editaCampos + '" id="G6_C41_' + editaCampos + '"></label></div>' +
            ...
            $("#btnAvanzadosField_" + editaCampos).click(function() {
                console.log('se oprime el icono de config [crear] :>> ' );
            ...
            $("#contadorEditablesPreguntas").val((Number(editaCampos) + 1));
        ...
        $("#newFieldSeccion2").click(function() {
            ...
            console.log('editaCampos :>> ', editaCampos);
            if (parseInt(editaCampos) > 29) {
                ...
                $("#btnAvanzadosField_" + editaCampos).click(function() {
                    console.log('se oprime el icono de config [edit_2] :>> ' );
                    var id = $(this).attr('valorField');
                    tipoCampo = $("#G6_C40_" + id).val();
                    $("#guardarConfiguracion").attr("numero", id);
                    mostrarModalConfiguracion(tipoCampo, id);
...
<script type="text/javascript">
        ...
        **/
        ...
        $("#guardarConfiguracion").click(function() {
            ...
            if (tipoCampo == '3' || tipoCampo == '4') {
                ...
                var nuevosCampos = $("#CuerpoTablaNuevosFields").html();
                ...
                if(tipoCampo == '1' || tipoCampo == '14'){
                    if(Number($("#G6_C339").val()) >= 10 && Number($("#G6_C339").val()) <= 253){
                        $("#G6_C339_" + idFila).val($("#G6_C339").val());
                    }else{                        
                        alertify.error("La longitud debe ser entre 10 y 253 caracteres");
                        valido=false;
                    }
                }
            }
    ...
    function validaRequerido(id){
        var result=true;
        console.log('id[validaRequerido] :>> ', id);
        $.ajax({
            url: '<?=$url_crud_extender?>?validaRequerido=si',
            async:false,
            type:'POST',
            dataType:'JSON',
            data:{id:id},
            success:function(data){
                console.log('data[validaRequerido] :>> ', data);
    ...
    function editaSeccion(id, tipoCampo = null, idFila = null) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log('data[editaSeccion] :>> ', data);
                if (data.code == '1') {
                    ...
                    $.each(data.datosPregun, function(campo, item) {
                        ...
                        cuerpoTablaQuesedebeGuardar = '<div class="row rowCampos" id="campos_' + campo + '" numero="' + campo + '">' +
                            ...
                            '<div class="col-md-1"  style="text-align:center;"><label><input type="checkbox" value="-1" name="G6_C41_' + campo + '" id="G6_C41_' + campo + '"></label></div>' +
                            '<div class="col-md-1" style="text-align:center;">' +
                        ...
                        $("#cuerpoTablaQuesedebeGuardarEdicion").sortable({
                            ...
                            update: function(event, ui) {
                                ...
                                console.log("cuerpoTablaQuesedebeGuardarEdicion", data);
                                $("#orderCamposCrearSeccionesEdicion").val(data);
                            }
                        });
                        ...
                        $("#btnAvanzadosField_" + campo).click(function() {
                            console.log('se oprime el icono de config [edit] :>> ' );
                            var id = $(this).attr('valorField');
                            tipoCampo = $("#G6_C40_" + id).val();
                            $("#guardarConfiguracion").attr("numero", id);
                            mostrarModalConfiguracion(tipoCampo, id);
    ...
    function guardaSeccion(cerrar, tipoCampo = null, idFila = null) {
        console.log("guardaSeccion",cerrar, tipoCampo, idFila)
                ...
                success: function(data) {
                    ...
                    if (data != '0') {
                        ...
                        if (cerrar) {
                            ...
                            console.log("idSeccionCrear", $("#IdseccionEdicion").val());
    ...
    const validarCrearSeccionesModal = () => {
        const modal = document.getElementById('crearSeccionesModal');
        let valueModal = modal.getAttribute('style','display: block;') === 'display: block;' ?  true : false;
    ...
    function mostrarModalConfiguracion(tipoCampo, idFila, modal = true) {
        ...
        console.log('group :>> ', tipoCampo, idFila, modal);  
        if (modal && tipoCampo != 12 ) {
            console.log("entra al if y se carga el loading");
            valido = valueModal === true ?  false : guardaSeccion(false, tipoCampo, idFila)            
        } else {
            valido = false;
            console.log("entra al else", valido);
        }
        
        console.log("valido [mostrarModalConfiguracion]", valido);

        if (!valido) {
            console.log('group entra al if :>> ', tipoCampo, idFila, modal);
            ...
            if (tipoCampo == '10') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log('data[camposGuion] :>> ', data);
                        ...
                        $.ajax({
                            ...
                            type: 'post',
                            success: function(datas) {
                                console.log('datas[camposGuion] :>> ', datas);
                                ListaCampoGuionMio = '<option value="0">Seleccione</option>';
                                ListaCampoGuionMio += datas;

                                /* Ahor atoca buscar si esa campo tiene asignados pregui */
                                if ($("#ConsInte_" + idFila)) {
                                    console.log('("#ConsInte_" + idFila) :>> ', $("#ConsInte_" + idFila));
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            console.log('data[tipoCampo = 11] validarPreguiPorCampo :>> ', data);
                                            if (data.code == '0') {
