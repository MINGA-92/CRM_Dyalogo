...
<?php
   ...
   $url_crud = "formularios/G21/G21_CRUD.php";
   //SECCION : CARGUE DATOS LISTA DE NAVEGACIÓN
    ...
    if(!isset($_GET['view'])){
        ...
        if($PEOBUS_VeRegPro__b != 0){
            $Zsql = "SELECT G21_ConsInte__b as id, G6_C39 as camp2, G6_C39 as camp1 FROM ".$BaseDatos.".G21  LEFT JOIN ".$BaseDatos.".G6 ON G6_ConsInte__b = G21_C205 LEFT JOIN ".$BaseDatos.".G6 ON G6_ConsInte__b = G21_C206 WHERE G21_Usuario = ".$idUsuario." ORDER BY G6_C39 DESC LIMIT 0, 50";
        }else{
            $Zsql = "SELECT G21_ConsInte__b as id, G6_C39 as camp2, G6_C39 as camp1 FROM ".$BaseDatos.".G21  LEFT JOIN ".$BaseDatos.".G6 ON G6_ConsInte__b = G21_C205 LEFT JOIN ".$BaseDatos.".G6 ON G6_ConsInte__b = G21_C206 ORDER BY G6_C39 DESC LIMIT 0, 50";
        }
    }else{
        $Zsql = "SELECT G21_ConsInte__b as id, G6_C39 as camp2, G6_C39 as camp1 FROM ".$BaseDatos.".G21  LEFT JOIN ".$BaseDatos.".G6 ON G6_ConsInte__b = G21_C205 LEFT JOIN ".$BaseDatos.".G6 ON G6_ConsInte__b = G21_C206 ORDER BY G6_C39 DESC LIMIT 0, 50";
    }
    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
                    ...
                    <?php 
                    $str_Lsql = "SELECT  G10_ConsInte__b as id , G10_C71 FROM ".$BaseDatos_systema.".G10";
                    ?>
                    <!-- CAMPO DE TIPO GUION -->
                    <div class="form-group">
                        <label for="G21_C204" id="LblG21_C204">CAMPAÑA</label>
                        <select class="form-control input-sm str_Select2" style="width: 100%;"  name="G21_C204" id="G21_C204">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
                    ...
                    <!-- CAMPO DE TIPO GUION -->
                    <div class="form-group">
                        <label for="G21_C205" id="LblG21_C205">PREGUNTA POBLACION</label>
                        <select class="form-control input-sm str_Select2" style="width: 100%;"  name="G21_C205" id="G21_C205">
                            <option>TEXTO</option>
                            <?php
                                /*
                                    SE RECORRE LA CONSULTA QUE TRAE LOS CAMPOS DEL GUIÓN
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
                    ...
                    <!-- CAMPO DE TIPO GUION -->
                    <div class="form-group">
                        <label for="G21_C206" id="LblG21_C206">PREGUNTA SCRIPT</label>
                        <select class="form-control input-sm str_Select2" style="width: 100%;"  name="G21_C206" id="G21_C206">
                            <option>TEXTO</option>
                            <?php
                                /*
                                    SE RECORRE LA CONSULTA QUE TRAE LOS CAMPOS DEL GUIÓN
...
<script type="text/javascript" src="cruds/DYALOGOCRM_SISTEMA/G21/G21_eventos.js"></script> 
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({
            ...
            success  : function(data){
                ...
                $.each(data, function(i, item) {
                        ...
                        $("#G21_C204").val(item.G21_C204);
 
                        $("#G21_C204").val(item.G21_C204).trigger("change"); 

                        $("#G21_C205").val(item.G21_C205);
 
                        $("#G21_C205").val(item.G21_C205).trigger("change"); 

                        $("#G21_C206").val(item.G21_C206);
 
                        $("#G21_C206").val(item.G21_C206).trigger("change"); 
        ...
        $("#G21_C204").change(function(){
            var valores = $("#G21_C204 option:selected").text();
            var campos = $("#G21_C204 option:selected").attr("dinammicos");
            var r = valores.split('|');
            if(r.length > 1){
        ...
        $("#G21_C205").change(function(){
            var valores = $("#G21_C205 option:selected").text();
            var campos = $("#G21_C205 option:selected").attr("dinammicos");
            var r = valores.split('|');
            if(r.length > 1){
        ...
        $("#G21_C206").change(function(){
            var valores = $("#G21_C206 option:selected").text();
            var campos = $("#G21_C206 option:selected").attr("dinammicos");
            var r = valores.split('|');
            if(r.length > 1){
    ...
    $("#btnBuscar").click(function(){
        ...
        $.ajax({
            url         : 'formularios/G21/G21_Funciones_Busqueda_Manual.php?action=GET_DATOS',
            type        : 'post',
            dataType    : 'json',
            data        : {  },
            success     : function(datosq){
                ...
                if(datosq[0].cantidad_registros > 1){
                    ...
                    $.each(datosq[0].registros, function(i, item) {
                        tabla_a_mostrar += '<tr ConsInte="'+ item.G21_ConsInte__b +'" class="EditRegistro">';
                        tabla_a_mostrar += '';
                        tabla_a_mostrar += '</tr>';
                    });
                    tabla_a_mostrar += '</tbody>';
                    ...
                    var id = datosq[0].registros[0].G21_ConsInte__b;
