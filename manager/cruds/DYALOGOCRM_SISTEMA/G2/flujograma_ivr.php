...
<?php
    include_once(__DIR__."/Controller/ListasDesplegables.php");
?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" name="CheckLunes" id="CheckLunes" checked> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckMartes" id="CheckMartes" checked> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckMiercoles" id="CheckMiercoles" checked> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckJueves" id="CheckJueves" checked> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckViernes" id="CheckViernes" checked> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 col-xs-5">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckSabado" id="CheckSabado"> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 col-xs-5">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckDomingo" id="CheckDomingo"> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4 col-xs-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label><input type="checkbox" value="-1" name="CheckFestivos" id="CheckFestivos"> </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 col-xs-5">
...
<div class="box-body">
    <div class="row">
        <div id="Loading_5" class="container-loader" style="margin-top: 11%; margin-left: 45%;" hidden>
            <div class="loader"></div>
            <p class="form-label text-black" style="margin-top: 28%; margin-left: 5%; color: #0028D2;"> GUARDANDO... </p>
            <img src="<?=base_url?>assets/img/loader.gif" style="margin-top: -20%; margin-left: -5%;">
        </div>
    </div>
</div>
                                                    ...
                                                    <form class="col-md-12 mb-12" style="margin-top: 5%;">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" class="form-control" id="InputOpcionIVR" value="Inicio IVR"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row" style="margin-top: 1%;">
                                                            ...
                                                            <div class="form-check col-md-3">
                                                                <label class="form-label" for="InputTiempoEspera">Tiempo De Espera: </label>
                                                                <input type="number" class="form-control" id="InputTiempoEspera" value="5"/>
                                                            </div>
        ...
        <div class="box-body">
            <div class="row">
                ...
                <form class="col-md-12 mb-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-check" id="divCampana_2" hidden>
                            <label class="form-label">Campaña: </label>
                            <div class="form-group">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div>
                    ...
                    <button class="btn btn-default" id="cancel" data-dismiss="modal" onclick="LimpiarTablaAvanzado();"><i class="fa fa-close" aria-hidden="true"></i></button>
                </div>
                <div>
...
<!-- Modal Esfera Final -->
<div class="modal fade bd-example-modal-sm" id="ModalEsferaFinal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="">×</button>
                <h4 class="modal-title"><b> Final De IVR </b></h4>
            </div>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12 mb-12" >
                        <div id="divBtnFinal">
                            <button class="btn btn-primary" id="BtnGuardarFinal" onclick="CapturarDatosAccion();"><i class="fa fa-save" aria-hidden="true"></i></button>
                            <button class="btn btn-default" id="cancel" data-dismiss="modal" onclick="LimpiarAcciones();"><i class="fa fa-close" aria-hidden="true"></i></button>
                        </div>
                    </div>
                    <br></br>
                    <input type="text" name="IdOpcion_6" id="IdOpcion_6" hidden>
                    <input type="text" name="IdAccion_5" id="IdAccion_5" hidden>
                </div>
                ...
                <form class="col-md-12 mb-12">
                    ...
                    <div class="row">
                        <div class="form-check col-md-12" id="divGrabaGrabaDespedida">
...
<!--  <script src="<?=base_url?>cruds/DYALOGOCRM_SISTEMA/G11/G11_EventosFlujograma.php"></script>  -->
            ...
            if(NumeroFilas == 0){
                ...
                if((IdAccion == null) || (IdAccion == "")){
                    ...
                    for(let i=0; i < NumeroFilas; i++) {
                        ...
                        var OrdenEjecucion= $("#OrdenEjecu_3").val();
                    ...
                    if((Etiqueta == null) || (Etiqueta == "")){
                        ...
                        var TransEncuesta= null;
                        var OrdenEjecucion= $("#OrdenEjecu_3").val();
                        var SelectAplicacion= document.getElementById("#Aplicacion_"+IdAccion);
                        //var TextoAplicacion= SelectAplicacion.options[SelectAplicacion.selectedIndex].text;
                        //var ValorAccion= TextoAplicacion+"("+Parametros+")";
                        
                        var ValorAccion= "AddQueueMember(Parámetros: [])";

                        
                        console.log("IdEsteIVR: ", IdEsteIVR);
            ...
            success : function(php_response){
                ...
                if(Respuesta == "Ok"){
                    ...
                    if(ValorAccion == 2){
                        ...
                        $("#IdOpcion_6").val(IdOpcion);
                        $("#IdAccion_5").val(IdAccion);
                        ...
                        $("#IdAccion_4").val(IdAccion);
                        $("#OrdenEjecu_3").val(OrdenEjecucion);
                    ...
                    success: function(php_response) {
                        ...
                        if(Respuesta == "Ok"){
                            ...
                            swal({
                                icon: 'error',
                                title: '❌  Oops...',
                                text: '¡Ya Existe Una Conexion Para Esta Esfera!',
                                confirmButtonColor: '#2892DB'
                            })
                            RecargarFlujograma(IdIVR);
                        }else if(Respuesta == "Nada"){
...
<script type="text/javascript">
    ...
    function verInformacion(from , to){
        ...
        console.log("verInformacion: ", verInformacion);
