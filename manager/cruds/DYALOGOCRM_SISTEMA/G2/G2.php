...
<script type="text/javascript">
    ...
    $(".reportesPantalla").click(function(){
        ...
        // validar si el boton editar ha sido habilitado 
        if (!$('#edit').is(':disabled')) {
         alertify.error("Debe seleccionar el icono de editar para realizar esta accion");
            return;
        }
...
<script type="text/javascript">
    $(function(){
        ...
        $("#Save").click(function(){
            ...
            // deshabilitar campo de configurar estrategia
+           $("#flujoEstrat").removeAttr("onclick");
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    if (obj['strMensaje_t'] == 'Reportes procesadoes: 0') {
                        ...
                        alertify.success("Envio Exitoso ".toUpperCase()+obj['strMensaje_t'].toUpperCase()+"<br>Por favor espere de 5 a 15 minutos");
                    }               
                },
                complete: function(){
                    $.ajax({
