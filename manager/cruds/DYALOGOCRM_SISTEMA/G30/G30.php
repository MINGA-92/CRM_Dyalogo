...
<?php
   ...
   $url_crud = base_url."cruds/DYALOGOCRM_SISTEMA/G30/G30_CRUD.php";
...
if($sql && $sql->num_rows == '1'){
    ...
    if($huesped && $huesped->num_rows == '1'){
        ...
        // Llenamos las opciones de campa�a
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="nombre" name="nombre" value="facebook_messenger_<?php echo $_GET['id_paso']; ?>" placeholder="<?php echo $str_nombre_mail_ms; ?>">
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="panel box box-primary">
                                    <div class="box-header with-border">
                                        <h4 class="box-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#facebookConfiguracion">
                                                Configuración
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="facebookConfiguracion" class="panel-collapse collapse in">
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Cuenta de Facebook Messenger a usar</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="campoBusquedaFb" id="campoBusquedaFb" class="form-control input-sm">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="">Detalle de la acci�n</label>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="">Mensaje</label>
                                                            <input type="text" id="fueraHorarioMensaje" name="fueraHorarioMensaje" class="form-control input-sm" value="Actualmente no estamos en horario de atenci�n">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    $(function(){
        ...
        $("#save").click(function(){
            ...
            if($("#campoBusquedaFb").val() == '' || $("#campoBusquedaFb").val() == 0){
                valido = false;
                $("#campoBusquedaFb").focus();
                alertify.error('Este campo es obligatorio');
            }
                ...
                $.ajax({
                    ...
                    error: function(data){
                        if(data.responseText){
                            alertify.error("Hubo un error al guardar la informaci�n" + data.responseText);
                        }else{
                            alertify.error("Hubo un error al guardar la informaci�n");
                        }
                    }
                });
            }
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.datosChat){
                    ...
                    $("#campoBusquedaFb").val(data.datosChat.id_pregun_campo_busqueda);
