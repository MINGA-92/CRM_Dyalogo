...
<?php
    ...
    $url_crud = base_url."cruds/DYALOGOCRM_SISTEMA/G36/G36_CRUD.php";
    $url_crud_extender = base_url."cruds/DYALOGOCRM_SISTEMA/G36/G36_extender_funcionalidad.php";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $str_robot;?></li>
        </ol>
    </section>
    <!-- Main content -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div id="12">
                                            ...
                                            <div class="row">
                                                <input type="hidden" value=""  name="G10_C75" id="G10_C75" hidden >
                                                <div class="col-md-6 col-xs-6" hidden>
                                                    <div class="form-group" id="tipoMarcador" requiredSelect>
                                                        ...
                                                        <select class="form-control input-sm str_Select2"  style="width: 100%;" name="G10_C76" id="G10_C76">
                                                            <option value="0">Seleccione</option>
                                                            <?php
                                                                $str_Lsql = "SELECT LISOPC_ValorNum_b AS OPCION_ConsInte__b, LISOPC_Nombre____b AS OPCION_Nombre____b FROM ".$BaseDatos_systema.".LISOPC_SISTEMA WHERE LISOPC_ConsInte__OPCION_b = 46 AND LISOPC_ValorNum_b > 3 ";
                                                ...
                                                <div class="col-md-6 col-xs-6">
                                                    <div class="form-group" id="distribuciondelTrabajo" hidden>
                                                        <label for="G10_C77" id="LblG10_C77">TIPO DISTRIBUCIÓN DEL TRABAJO</label>
                                                        <select class="form-control input-sm str_Select2"  style="width: 100%;" name="G10_C77" id="G10_C77">
                                                            <?php
...
<script type="text/javascript">
    ...
    $("#aColaMarcador").click(function(){
        ...
        $("#ifrVisorColaMArcador").attr("src","<?=base_url?>pages/Dashboard/reportMarcador.php?Campan="+idCampan+"&Estpas="+idEstpas+"&tipoMarc="+typeCampan);
...
<script type="text/javascript">
    $(function(){
        ...
        $("#G10_C331").change(function(){
            // Como es marcador robotico el temaño de la manotada es el mismo que el de canales del robot
            $("#G10_C93").val($("#G10_C331").val());
        })
            ...
            $.ajax({
                ...
                success  : function(data){
                    ...
                    if(data.length > 0){
                        ...
                        <?php if(isset($_GET["newMarcador"])) { ?>

                        const nameScript = $('#G10_C73 option[value="'+$("#G10_C73").val()+'"]').text();
                        swal("Se ha generado el Marcador", "Para guardar las gestiones del marcador robótico se generó automáticamente el formulario '"+nameScript+"', recuerde que para empezar a usar el marcador debe de seleccionar la troncal de la cual se van a sacar las llamadas", "success");
...
<script type="text/javascript">
    ...
    */
    ...
    function renderizarCondiciones(){
        ...
        let texto = '';
        let newCuantosvan = $("#FILTROS :input:not('button')").not('input[id^="tipo_campo"]').last().attr("numero");

        for (let index = 1; index <= newCuantosvan; index++) {

            if($("#FILTROS div#id_"+index).length){

                let apertura = '<b>'+$("#andOr_"+index+" option:selected").html()+'</b>';
