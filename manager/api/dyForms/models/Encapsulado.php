...
class Encapsulado {
    ...
    {
        $this->strNombre = self::$db->real_escape_string($strNombre);
        return $this;
    }
    ...
    public function setStrCampoGuionAux($strCampoGuionAux)
    {
        if(is_null($strCampoGuionAux)){
            ...
            $this->strCampoGuionAux = Helpers::decodeId(self::$db->real_escape_string($strCampoGuionAux), 'PREGUN_ConsInte__b', 'DYALOGOCRM_SISTEMA.PREGUN');
        }
        return $this;
    }
    ...
    {
        $this->intOpcionId = $intOpcionId;
        return $this;
        Helpers::decodeId(self::$db->real_escape_string($intOpcionId), 'LISOPC_ConsInte__b', 'DYALOGOCRM_SISTEMA.LISOPC');
    }
