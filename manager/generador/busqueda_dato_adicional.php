<?php
	function generar_Busqueda_Dato_Adicional($idFormulario_Crear){
		global $mysqli;
		global $BaseDatos;
		...
		if(!is_null($idFormulario_Crear)){
			...
			$datosDestr_Tiene_Maestro_Relacion_O_No = '';
			/* Insertar los datos adicionales */
			$datosInsertarn = '';
			$inserts = '';
			$intos = '';

			/*if(!is_null($CAMPAN_CamAd1Cbx_b)){
				$inserts .= ', G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.' ';
				$intos .= ', \'".$_GET[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b .'\']."\'';

				$where .= '
		if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\'])){
			if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\'] != \'\'){
				$and = null;
				if($usados == 1){
					$and = " AND ";
				}
				$Where .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.' = \'". $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\'] ."\' ";
				$usados = 1;
			}
		}';	
			...
			if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\'])){
				if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\'] != \'\'){
					...
					$inserts .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.' ";
					$values  .= $and.$_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b.'\'];
					$usados = 1;
				}
			}';

$datos .= '<?php if(isset($_GET[\'dato_adicional_1\'])){ echo " G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b .' : \'". $_GET[\'dato_adicional_1\']."\',"; }?>'; 
$datosDestr_Tiene_Maestro_Relacion_O_No .= '<?php if(isset($_GET[\'dato_adicional_1\'])){ echo "&G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd1Cbx_b .'=". $_GET[\'dato_adicional_1\']; }?>';
			}

			if(!is_null($CAMPAN_CamAd2Cbx_b)){
				$inserts .= ', G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.' ';
				$intos .= ', \'".$_GET[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b .'\']."\'';


				$where .= '
		if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\'])){
			if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\'] != \'\'){
				$and = null;
				if($usados == 1){
					$and = " AND ";
				}
				$Where .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.' = \'". $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\'] ."\' ";
				$usados = 1;
			}
		}';		
			...
			if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\'])){
				if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\'] != \'\'){
					...
					$inserts .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.' ";
					$values  .= $and.$_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b.'\'];
					$usados = 1;
				}
			}';

$datos .= '<?php if(isset($_GET[\'dato_adicional_2\'])){ echo " G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b .' : \'". $_GET[\'dato_adicional_2\']."\',"; }?>'; 
$datosDestr_Tiene_Maestro_Relacion_O_No .= '<?php if(isset($_GET[\'dato_adicional_2\'])){ echo "&G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd2Cbx_b .'=". $_GET[\'dato_adicional_2\']; }?>'; 
			}

			if(!is_null($CAMPAN_CamAd3Cbx_b)){
				$inserts .= ', G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.' ';
				$intos .= ', \'".$_GET[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b .'\']."\'';

				$where .= '
		if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\'])){
			if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\'] != \'\'){
				$and = null;
				if($usados == 1){
					$and = " AND ";
				}
				$Where .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.' = \'". $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\'] ."\' ";
				$usados = 1;
			}
		}';	
			...
			if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\'])){
				if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\'] != \'\'){
					...
					$inserts .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.' ";
					$values  .= $and.$_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b.'\'];
					$usados = 1;
				}
			}';

$datos .= '<?php if(isset($_GET[\'dato_adicional_3\'])){ echo " G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b .' : \'". $_GET[\'dato_adicional_3\']."\',"; }?>'; 	
$datosDestr_Tiene_Maestro_Relacion_O_No .= '<?php if(isset($_GET[\'dato_adicional_3\'])){ echo "&G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd3Cbx_b .'=". $_GET[\'dato_adicional_3\']; }?>'; 	
			}

			if(!is_null($CAMPAN_CamAd4Cbx_b)){
				$inserts .= ', G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.' ';
				$intos .= ', \'".$_GET[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b .'\']."\'';

				$where .= '
		if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\'])){
			if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\'] != \'\'){
				$and = null;
				if($usados == 1){
					$and = " AND ";
				}
				$Where .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.' = \'". $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\'] ."\' ";
				$usados = 1;
			}
		}';	
			...
			if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\'])){
				if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\'] != \'\'){
					...
					$inserts .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.' ";
					$values  .= $and.$_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b.'\'];
					$usados = 1;
				}
			}';
				
$datos .= '<?php if(isset($_GET[\'dato_adicional_4\'])){ echo " G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b .' : \'". $_GET[\'dato_adicional_4\']."\',"; }?>'; 
$datosDestr_Tiene_Maestro_Relacion_O_No .= '<?php if(isset($_GET[\'dato_adicional_4\'])){ echo "&G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd4Cbx_b .'=". $_GET[\'dato_adicional_4\']; }?>'; 
			}

			if(!is_null($CAMPAN_CamAd5Cbx_b)){
				$inserts .= ', G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.' ';
				$intos .= ', \'".$_GET[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b .'\']."\'';


				$where .= '
		if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\'])){
			if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\'] != \'\'){
				$and = null;
				if($usados == 1){
					$and = " AND ";
				}
				$Where .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.' = \'". $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\'] ."\' ";
				$usados = 1;
			}
		}';	
			...
			if(isset($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\'])){
				if(!is_null($_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\']) && $_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\'] != \'\'){
					...
					$inserts .= $and." G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.' ";
					$values  .= $and.$_POST[\'G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b.'\'];
					$usados = 1;
				}
			}';

$datos .= '<?php if(isset($_GET[\'dato_adicional_5\'])){ echo " G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b .' : \'". $_GET[\'dato_adicional_5\']."\',"; }?>'; 	
$datosDestr_Tiene_Maestro_Relacion_O_No .= '<?php if(isset($_GET[\'dato_adicional_5\'])){ echo "&G'.$idFormulario_Crear.'_C'.$CAMPAN_CamAd5Cbx_b .'=". $_GET[\'dato_adicional_5\']; }?>'; 	
			}

		
			$carpeta = "formularios/G".$idFormulario_Crear;
		    ...
		    $fp = fopen($carpeta."/G".$idFormulario_Crear."_Busqueda_ani.php" , "w");
		    //chmod($carpeta."/G".$idFormulario_Crear."_Busqueda_ani.php" , 0777); 
...
<script type="text/javascript">
	...
	function buscar_valores(){
		$.ajax({
			...
			/* escribimos el codigo generado en el archivo y cerramos el editor */
