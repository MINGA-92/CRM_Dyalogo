...
?>
<script src="<?=base_url_admin?>plugins/sortablejs/sortablejs.js"></script>
<script>
    ...
    $('#secProveedoresSms table').on('click', '.btn-editar-proveedor-sms', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/proveedor-sms/'+id,
            success: function (response) {
    ...
    $('#modal-proveedorSms #btn-guardar-proveedor-sms').on('click', function(e){
        ...
        switch (accion) {
            case 'registrar':
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/crear-proveedor-sms/'+id_huesped,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
            ...
            case 'actualizar':
                ...
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/actualizar-proveedor-sms/'+id,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    type: 'DELETE',
                    dataType: 'json',
                    url: '<?=base_url_admin?>api/huesped/eliminar-proveedor-sms/'+id,
                    data: JSON.stringify({
                        "id": id,
                        ...tokenApi
                    }),
    ...
    function getProveedoresSms(id){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/listar-proveedores-sms/'+id,
            success: function (response) {
                let html11 = '';
    ...
    $('#modal-prueba-proveedorSms #btn-probar-proveedor-sms').on('click', function(){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/huesped/prueba-proveedor-sms',
            type: 'POST',
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    $('#secCuentasCorreo table').on('click', '.btn-editar-cuenta-correo', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/cuenta-correo/'+id,
            success: function (response) {
    ...
    $('#modal-cuentaCorreo #btn-guardar-cuenta-correo').on('click', function(e){
        ...
        // Se adiciona el token para la api
        data.append("strUsuario_t", tokenApi.strUsuario_t);
        data.append("strToken_t", tokenApi.strToken_t);
        var id = $('input#id').val();
        ...
        switch (accion) {
            case 'registrar':
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/crear-cuenta-correo/'+id,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
            ...
            case 'actualizar':
                ...
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/actualizar-cuenta-correo/'+id_registro,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    headers: {"Content-Type": "application/json"},
                    type: 'DELETE',
                    url: '<?=base_url_admin?>api/huesped/eliminar-cuenta-correo/'+id,
                    data: JSON.stringify({
                        "id": id,
                        ...tokenApi
                    }),
    ...
    function getCuentasCorreo(id){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/listar-cuentas-correo/'+id,
            success: function (response) {
                let html11 = '';
    ...
    function testSendMailService(data1){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/huesped/test-correo-send-mail-service',
            type: 'POST',
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    function testEntrada(data1){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/huesped/test-correo-in',
            type: 'POST',
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    function getTroncales(id){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/listar-troncales/'+id,
            success: function (response) {
                let html11 = '';
    ...
    function getEstadosTroncales(id_huesped){
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/estado-troncal/'+id_huesped,
            success: function (response) {
        ...
        Swal.fire({
            ...
            if (result.value) {    
                ...
                if(propiedadId != 0){
                    ...
                    tokenApi.propiedadId = propiedadId;
                    ...
                    $.ajax({
                        ...
                        url: '<?=base_url_admin?>api/huesped/eliminar-propiedad-troncal',
                        data: JSON.stringify(tokenApi),
                        success: function (response) {
                            Swal.fire(
                                'Eliminado!',
    ...
    $('#btn-agregar-troncal').on('click', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/obtener-propiedades',
            success: function (response) {
    ...
    $('#modal-troncal #btn-guardar-troncal').on('click', function(e){
        ...
        switch (accion) {
            case 'registrar':
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/crear-troncal/'+id_huesped,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
            ...
            case 'actualizar':
                data.append('_method', 'PUT');
                data.append('strToken_t', '<?=admin_token_api?>');
                data.append('strUsuario_t', 'adminApi');

                var id_troncal = $('#form-troncal #id_troncal').val();

                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/actualizar-troncal/'+id_troncal,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
    ...
    $('#secTroncales table').on('click', '.btn-editar-troncal', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/troncal/'+id,
            success: function (response) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    type: 'DELETE',
                    dataType: 'json',
                    url: '<?=base_url_admin?>api/huesped/eliminar-troncal/'+id_troncal,
                    data: JSON.stringify({
    ...
    function listarPatrones(id_huesped){
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/patron/'+id_huesped,
            success: function (response) {
    ...
    $('#form-patrones table tbody').on('click', '.guardar-patron', function(e){
        ...
        if(id > 0){
            // Actualizar patron
            var ruta = "<?=base_url_admin?>api/huesped/actualizar-patron/"+id;
        }else{
            // Crear patron
            var ruta = "<?=base_url_admin?>api/huesped/crear-patron/"+id_huesped;
        }
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: JSON.stringify({"nombre": nombrep, "patron": patronp, "codigo": codigo, ...tokenApi}),
            success: function(response){
                toastr.success(response.message);
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        headers: {"Content-Type": "application/json"},
                        type: 'post',
                        url: '<?=base_url_admin?>api/huesped/eliminar-patron/'+id,
                        dataType: 'json',
                        data: JSON.stringify({
                            "id": id,
                            ...tokenApi
    ...
    $('#detallePatron tbody').on('click', '.agegarCodigo', function(e){
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: JSON.stringify({"nombre": nombrep, "patron": patronp, "codigo": codigop, "ejemplo": ejemplop, "agregarCodigoPais": agregarCodigoPais, ...tokenApi}),
            success: function(response){
                toastr.success(response.message);
                listarPatrones(id_huesped);
    ...
    $('#buscarPatronByPais').on('click', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/listar-patrones/'+codigo,
            success: function (response) {
                ...
                if(response.patrones){
                    $.each(response.patrones, function(key, value){
                        ...
                        <tr>
                            ...
                            <td hidden="true">
                                <input type="input" id="ejemplo${value.id}" name="ejemplo${value.id}" class="form-control input-sm" style="width:60%" value="${value.patron}" placeholder="XXXXXXXXXX"></td>
                            <td>
    ...
    $('#agregarPersonalizado').on('click', function(){
        ...
        html11 += `
            <tr>
                ...
                <td hidden="true"><input type="text" id="ejemploPer" name="ejemploPer" class="form-control input-sm" style="width:60%" placeholder="XXXXXXXXXX"></td>
                <td>
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    type: 'POST',
                    url: '<?=base_url_admin?>api/huesped/webservice-borrar/'+id,
                    data: JSON.stringify({
                        "id": id,
                        ...tokenApi
                    }),
    ...
    $("#btn-guardar-webservice").on('click', function(e){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/huesped/webservice-save/'+id_huesped,
            type: 'POST',
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    $('#secWebservice table tbody').on('click', '.btn-editar-webservice', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/webservice-data/'+id,
            success: function (response) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        type: 'POST',
                        url: '<?=base_url_admin?>api/huesped/webservice-borrar-header/'+headerId,
                        data: JSON.stringify({
                            "id": headerId,
                            ...tokenApi
                        }),
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        url: '<?=base_url_admin?>api/huesped/webservice-borrar-parametro/'+parametroId,
                        data: JSON.stringify({
                            "id": parametroId,
                            ...tokenApi
                        }),
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        url: '<?=base_url_admin?>api/huesped/webservice-borrar-parametro-retorno/'+parametroId,
                        data: JSON.stringify({
                            "id": parametroId,
                            ...tokenApi
                        }),
    ...
    function listarServices(huespedId){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/webservice/'+huespedId,
            success: function (response) {
                console.log(response);
                let html11 = '';
    ...
    $("#btn-guardar-plantilla-whatsapp").on('click', function(e){
        ...
        if(valido){
            $.ajax({
                url: '<?=base_url_admin?>api/huesped/plantilla-w-save/'+id_huesped,
                type: 'POST',
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function agregarPlantilla(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/whatsapp-all/'+id,
            success: function (response) {
    ...
    function cargarListaPlantillas(id, cargadoDesdeBoton = false){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/plantillas-wa/'+id,
            beforeSend: function(){
                $('#mostrar_loading').addClass('loader');
            },
            success: function (response) {
    ...
    $('#secPlantillasWhatsapp table tbody').on('click', '.btn-show-plantilla-wa', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/whatsapp-all/'+huespedId,
            success: function (response) {
                let htmlw = '<option value="">Seleccione</option>';
                if(response.res.channels.length > 0){
                    $.each(response.res.channels, function(key, value){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/plantilla-wa-data/'+id,
            success: function (response) {
    ...
    $('#secPlantillasWhatsapp table tbody').on('click', '.btn-eliminar-plantilla-wa', function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                $('#mostrar_loading').addClass('loader');
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/plantilla-wa-delete/'+plantillaId,
                    headers: { "Content-Type": "application/json"},
                    type: 'DELETE',
                    dataType: 'json',
                    data: JSON.stringify({plantillaId: plantillaId, canal: canal, ...tokenApi}),
                    success: function (response) {
    ...
    $('#secWhatsapp table').on('click', '.btn-editar-whatsapp', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/whatsapp/'+id,
            success: function (response) {
    ...
    $('#modal-whatsapp #btn-guardar-whatsapp').on('click', function(e){
        ...
        switch (accion) {
            case 'registrar':
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/crear-whatsapp/'+id_huesped,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
            ...
            case 'actualizar':
                ...
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/actualizar-whatsapp/'+id_whatsapp,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
    ...
    $("#secWhatsapp table").on('click', '.btn-eliminar-whatsapp', function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                $('#mostrar_loading').addClass('loader');
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/eliminar-whatsapp/'+delId,
                    data: JSON.stringify(tokenApi),
                    headers: {
                        "Content-Type": "application/json"
                    },
    ...
    $("#modal-test-whatsapp #btnTestSalida").on('click', function(){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/channel/test/w/send',
            type: 'POST',
            dataType: 'json',
    ...
    function traerMensajesW(id){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/channel/test/w/out/'+id,
            type: 'POST',
            dataType: 'json',
            processData: false,
            contentType: false,
    ...
    function test(activo){
        ...
        var ruta = '';
        if(activo){
            ruta = '<?=base_url_admin?>api/channel/test/w/activate/'+miId;
        }else{
            ruta = '<?=base_url_admin?>api/channel/test/w/deactivate/'+miId;
        }
    ...
    function getChannelsF(id){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/facebook-all/'+id,
            beforeSend: function(){
    ...
    $('#secFacebook table').on('click', '.btn-editar-facebook', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/facebook/'+id,
            success: function (response) {
    ...
    $('#modal-facebook #btn-guardar-facebook').on('click', function(e){
        ...
        switch (accion) {
            case 'registrar':
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/crear-facebook/'+id_huesped,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
            ...
            case 'actualizar':
                ...
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/actualizar-facebook/'+id_facebook,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
                    contentType: false,
    ...
    $("#secFacebook table").on('click', '.btn-eliminar-facebook', function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                $('#mostrar_loading').addClass('loader');
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/eliminar-facebook/'+delId,
                    data: JSON.stringify(tokenApi),
                    dataType: 'json',
                    "headers": {
                        "Content-Type": "application/json"
    ...
    $("#modal-test-facebook #btnTestSalidaF").on('click', function(){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/channel/test/f/send',
            headers: {"Content-Type": "application/json"},
            type: 'POST',
            dataType: 'json',
            data: JSON.stringify({'from':from, 'to':to, ...tokenApi}),
            success: function(response){
                console.log(response);
                Swal.fire(
                    'Enviado!',
    ...
    function traerMensajesF(id){
        ...
        $.ajax({
            url: '<?=base_url_admin?>api/channel/test/f/out/'+id,
            headers: {"Content-Type": "application/json"},
            data: JSON.stringify(tokenApi),
            type: 'POST',
            dataType: 'json',
    ...
    function testF(activo){
        ...
        var ruta = '';
        if(activo){
            ruta = '<?=base_url_admin?>api/channel/test/f/activate/'+miId;
        }else{
            ruta = '<?=base_url_admin?>api/channel/test/f/deactivate/'+miId;
        }
    ...
    $("#btn-guardar-instagram").on('click', function(e){
        ...
        let url = '<?=base_url_admin?>api/huesped/crear-instagram/'+id_huesped;
        ...
        if(accion == 'actualizar'){
            ...
            url = '<?=base_url_admin?>api/huesped/actualizar-instagram/'+id_instagram;
    ...
    function obtenerCanalesInstagram(id){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/all-instagram/'+id,
            beforeSend: function(){
                $('#secFacebook table tbody').html(`
                    <tr>
                        <td colspan="5"><h4>Cargando...</h4></td>
    ...
    $('#secInstagram table').on('click', '.btn-editar-instagram', function(){
        ...
        $.ajax({
            ...
            url: '<?=base_url_admin?>api/huesped/instagram/'+id,
            success: function (response) {
    ...
    $('#secInstagram table').on('click', '.btn-eliminar-instagram', function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: '<?=base_url_admin?>api/huesped/eliminar-instagram/'+id,
                    data: JSON.stringify(tokenApi),
                    "headers": {
                        "Content-Type": "application/json"
                    },
