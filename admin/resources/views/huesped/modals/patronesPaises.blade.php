                    ...
                    <div class="col-md-12">
                        <table class="table" id="detallePatron">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Patron<br><small>(Formato con el que se almacenan los números en BD)</small></th>
                                    <th>Codigo Pais</th>
                                    <th>Ejemplo personalizado<br><small>(Este sera visible en un formulario si la validacion falla)</small></th>
                                </tr>
                            </thead>
                            <tbody>
